...
## Slide 6: Data Flow Diagram (Level 2 - Arrival Logging)

```mermaid
graph TD
    subgraph P2: Arrival Logging Detail
        Driver([Driver]) -->|Trigger Arrival| p21[2.1 Capture Timestamp]
        p21 -->|Current Time| p23[2.3 Calculate Delay]
        
        DB[(Firestore DB)] -->|Fetch Schedule| p22[2.2 Retrieve Shift Data]
        p22 -->|Planned Time| p23
        
        p23 -->|Delay > 10m| p24[2.4 Penalize Points]
        p23 -->|Arrival Info| p25[2.5 Create Log Entry]
        
        p24 -->|Point Deduction| DB
        p25 -->|Log Status| DB
        
        p25 -->|Confirmation| Driver
    end
```
...
## Slide 9: Technical Modules (Phase 2)
...
## Slide 10: UML Sequence Diagram (Performance Penalty Flow)
...
## Slide 11: UML Activity Diagram (Workflow)
...
## Slide 12: Quantitative Impact & Results
